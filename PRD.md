...
- Sources indexées:
  ...
  - Prédications William Branham (Le Grenier du Message - 1000 premiers paragraphes)
  - Études bibliques Branham.org (4 études: La semence du serpent, La trinité, La communion, Le baptême d'eau)
  - Tracts TheMessage.com (7 tracts: Le jugement, La vie après la mort, Le péché originel, Au Nom, Le surnaturel, Le redoutable jour de l'Éternel, Le Messager)
  - Prédications du pasteur (optionnel - post-MVP)
...
- **LLM API:** Groq (llama-3.3-70b-versatile) - Gratuit, rapide
- **Embeddings:** Ollama (nomic-embed-text) - Local, gratuit
- **LLM:** Groq (llama-3.3-70b-versatile) - Gratuit, rapide
...
- [x] Interface admin upload
- [x] Parser fichiers txt/docx/pptx
- [x] Setup Upstash Vector
- [x] Génération embeddings (Ollama nomic-embed-text)
- [x] Indexer les 3 Bibles (Darby, Martin, Segond)
- [x] Indexer prédications Branham (1000 premiers paragraphes)
- [ ] Indexer études bibliques Branham.org (4 études)
- [ ] Indexer tracts TheMessage.com (7 tracts)

### Phase 4 - Recherche IA (Semaine 3-4)

- [x] Interface de recherche (chat style Claude)
- [x] API endpoint /api/search
- [x] Recherche vectorielle (Upstash Vector)
- [x] Mode conversationnel avec Groq (llama-3.3-70b-versatile)
- [x] Streaming des réponses en temps réel
- [x] Système prompt conversationnel avec formatage des citations
- [x] Affichage des résultats + sources
- [x] Historique des recherches sauvegardé en DB
...
**Sources William Marrion Branham:**
- Branham.org: https://branham.org
  - Études bibliques: https://branham.org/fr/biblestudy
    - La semence du serpent: https://branham.org/fr/biblestudy/TheSerpentSeed
    - La trinité: https://branham.org/fr/biblestudy/TheTrinity
    - La communion: https://branham.org/fr/biblestudy/Communion
    - Le baptême d'eau: https://branham.org/fr/biblestudy/WaterBaptism
- TheMessage.com: https://themessage.com
  - Tracts français: https://themessage.com/fr/tracts
    - Le jugement: https://www.themessage.com/fr/judgment
    - La vie après la mort: https://www.themessage.com/fr/lifeafter
    - Le péché originel: https://www.themessage.com/fr/originalsin
    - Au Nom: https://www.themessage.com/fr/inthename
    - Le surnaturel: https://www.themessage.com/fr/supernatural
    - Le redoutable jour de l'Éternel: https://www.themessage.com/fr/dreadful
    - Le Messager: https://www.themessage.com/fr/messenger
