...
const TRACTS: Tract[] = [
  {
    title: "Le jugement",
    url: "https://www.themessage.com/fr/judgment",
    slug: "judgment"
  },
  {
    title: "La vie après la mort",
    url: "https://www.themessage.com/fr/lifeafter",
    slug: "lifeafter"
  },
  {
    title: "Le péché originel",
    url: "https://www.themessage.com/fr/originalsin",
    slug: "originalsin"
  },
  {
    title: "Au Nom",
    url: "https://www.themessage.com/fr/inthename",
    slug: "inthename"
  },
  {
    title: "Le surnaturel",
    url: "https://www.themessage.com/fr/supernatural",
    slug: "supernatural"
  },
  {
    title: "Le redoutable jour de l'Éternel",
    url: "https://www.themessage.com/fr/dreadful",
    slug: "dreadful"
  },
  {
    title: "Le Messager",
    url: "https://www.themessage.com/fr/messenger",
    slug: "messenger"
  }
]

async function fetchTractContent(url: string): Promise<string> {
...
async function indexTracts() {
  console.log("🚀 Starting TheMessage.com Tracts indexation...\n")

  for (const tract of TRACTS) {
    console.log(`📄 Processing: ${tract.title}`)
    ...
    try {
      ...
      // Fetch content
      console.log(`   📥 Fetching content from ${tract.url}`)
      const content = await fetchTractContent(tract.url)
      ...
      const document = await prisma.document.upsert({
        where: {
          id: existing?.id || `tract-${tract.slug}`
        },
        create: {
          id: `tract-${tract.slug}`,
          title: tract.title,
      ...
      console.error(`   ❌ Error processing ${tract.title}:`, error)
      console.log()
    }
  }

  console.log("✅ TheMessage.com Tracts indexation completed!")
}
